...
namespace WindowsFormsApplication1
{
    public partial class Form1 : Form
    {
        ...
        {
            Str_App_c = "App_" + textBox1.Text + ".c";
            Str_App_h = "App_" + textBox1.Text + ".h";
            Str_Drive_c = "Drive_" + textBox1.Text + ".c";
            Str_Drive_h = "Drive_" + textBox1.Text + ".h";
            ...
            //Flag_App = checkBox3.Checked;
            //Flag_Drive = checkBox4.Checked;
            //Flag_AppBack = checkBox5.Checked;
            //Flag_AppStart = checkBox1.Checked;
            //Flag_AppEnd = checkBox2.Checked;

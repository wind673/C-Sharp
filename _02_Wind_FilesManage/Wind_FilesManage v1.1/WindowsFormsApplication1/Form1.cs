...
namespace WindowsFormsApplication1
{
    public partial class Form1 : Form
    {
        ...
        private void Create_App_c_Str()//填写文件内容
        {
            ...
            + "* @Explain       : None" + "\n"
            + "------------------------------------------------------------------------------*/" + "\n"
            + "unsigned int " + Str_Name + "_Main(void)" + "\n"
            + "{  " + "\n" + "\n" + "\n" + "\n"
            + "    return 0;" + "\n"
            + "}	" + "\n" + "\n";
            ...
            if (Flag_AppBack)
            {
                Str_App_c += "unsigned int " + Str_Name + "_Back(void)" + "\n"
                 + "{  " + "\n" + "\n" + "\n" + "\n"
                 + "    return 0;" + "\n"
                 + "}	" + "\n" + "\n";
            }
            if (Flag_AppStart)
            {
                Str_App_c += "unsigned int " + Str_Name + "_Start(void)" + "\n"
                 + "{  " + "\n" + "\n" + "\n" + "\n"
                 + "    return 0;" + "\n"
                 + "}	" + "\n" + "\n";
            }
            if (Flag_AppEnd)
            {
                Str_App_c += "unsigned int " + Str_Name + "_End(void)" + "\n"
                 + "{  " + "\n" + "\n" + "\n" + "\n"
                 + "    return 0;" + "\n"
                 + "}	" + "\n" + "\n";
            }
